...
class Context {
    constructor(definitions, namespaces, checks, loader) {
        ...
        this.checks = checks;
        this.loader = loader;
        this.plugins = (0, maybe_1.nothing)();
    }
    /**
     * addDefinitions to the Context.
     */
    addDefinitions(defs) {
        this.definitions = (0, record_1.merge)(this.definitions, defs);
        return this;
    }
    /**
     ...
     */
    setPlugin(plugin) {
        this.plugins = (0, maybe_1.just)(plugin);
        return this;
    }
    /**
    ...
    fragmentResolution(o) {
        return ((0, loader_1.resolve)(this.loader, this.namespaces)(o));
    }
    /**
     ...
     */
    schemaExpansion(o) {
        return (0, future_1.pure)((0, schema_1.expand)(o));
    }
    /**
    ...
    definitionRegistration(o) {
        return (0, future_1.pure)((0, record_1.isRecord)(o.definitions) ?
     ...
     */
    definitionMerging(o) {
        let eresult = (0, definitions_1.resolve)(this.definitions)(o);
    ...
    checkStage(o) {
        return this
            .checks
            .reduce(chainCheck, (0, builtin_1.check)(o))
            .fold(checksFailed(this), (o) => (0, future_1.pure)(o));
    }
    /**
    ...
    compile(doc) {
        ...
        return (0, monad_1.doN)(function* () {
            ...
            if (that.plugins.isJust())
                ...
                return (0, future_1.pure)(doc);
        });
    }
}
exports.Context = Context;
const mergingFailed = (c, f) => (0, future_1.raise)(f.toError({}, c));
const mergingComplete = (o) => (0, future_1.pure)(o);
const checksFailed = (_) => (f) => (0, future_1.raise)(new Error(`${JSON.stringify(f.explain())}`));
