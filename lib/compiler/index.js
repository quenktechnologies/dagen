...
class Context {
     ...
     */
    definitionMerging(o) {
        return either_1.either(mergingFailed(this))(mergingComplete)(definitions_1.resolve(this.definitions)(o));
    }
    /**
...
const checksFailed = (_) => (f) => future_1.raise(new Error(`${JSON.stringify(f.value)}`));
