...
exports.extract = exports.Compile = void 0;
...
class Compile {
    ...
    run() {
        ...
        return monad_1.doN(function* () {
            ...
            let ctx = new compiler_1.Context({}, argv.namespace, [], new file_system_1.FileSystemLoader(path_1.dirname(file)));
            let plist = yield __1.loadPlugins(ctx, argv.plugin);
            let plugins = new plugin_1.CompositePlugin(plist);
            let config = yield (__1.setValues({})(argv.config));
            ...
            let checks = yield __1.loadChecks(argv.check, pluginChecks);
