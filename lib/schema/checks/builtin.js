...
exports.providers = {
    eq: prec.eq,
    neq: prec.neq,
    nn: function_1.cons(prec.notNull),
    gt: numbers.gt,
    lt: numbers.lt,
    uppercase: function_1.cons(strings.uppercase),
    lowercase: function_1.cons(strings.lower),
    maxLength: strings.maxLength,
    minLength: strings.minLength,
    trim: function_1.cons(strings.trim),
...
exports.check = _1.fromSchema((new _1.Context({}, exports.providers))
