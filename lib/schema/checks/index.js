...
const fromMapObject = (c) => ({ properties, additionalProperties, $checks }) => preconditions_1.every(records.isRecord, records.union(record_1.map(properties, exports.fromSchema(c))), records.map(exports.fromSchema(c)(additionalProperties)), spec_1.specs2Checks(c.providers)($checks || []));
