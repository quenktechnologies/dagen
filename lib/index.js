...
const _set2Context = (values) => (program) => Promise.resolve(values.reduce((p, kvp) => p.then(prog => {
    ...
    return startsWith(exports.MODULE_SCHEME, value) ?
        ...
        startsWith(exports.EVAL_SCHEME, value) ?
            exports.resolve(exports.readModule(value.split(`${exports.EVAL_SCHEME}://`)[1]))
 ...
 * readRef into memory.
 */
exports.readRef = (program) => (path) => exports.readJSONFile(path)
 ...
 */
exports.evaluate = (program) => (json) => Array.isArray(json) ?
    Promise
