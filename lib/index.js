...
exports.objectTypeChecks = {
    ...
    get properties() {
        return preconditions_1.and(preconditions_1.object, preconditions_1.visit(exports.propertiesCheck));
    }
};
/**
...
exports.sumTypeChecks = {
    ...
    discriminator: preconditions_1.optional(preconditions_1.string),
    variants: preconditions_1.partial(exports.typeChecks)
};
/**
 * propertiesCheck for the properties property of ObjectTypes.
 */
exports.propertiesCheck = preconditions_1.when(exports.isObjectType, preconditions_1.map(exports.objectTypeChecks), preconditions_1.when(exports.isArrayType, preconditions_1.map(exports.arrayTypeChecks), preconditions_1.when(exports.isSumType, preconditions_1.map(exports.sumTypeChecks), preconditions_1.map(exports.typeChecks))));
/**
 * documentChecks for the Document interface.
 */
exports.documentChecks = util_1.fuse(exports.objectTypeChecks, { title: preconditions_1.optional(preconditions_1.string) });
/**
...
exports.execute = (prog) => prog
    ...
    .then(exports.check(preconditions_1.map(exports.documentChecks)))
