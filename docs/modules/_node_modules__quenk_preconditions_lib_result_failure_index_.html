...
<head>
	...
	<title>&quot;node_modules/@quenk/preconditions/lib/result/failure/index&quot; | @quenk/dagen</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		...
		<li class=" tsd-kind-type-alias tsd-parent-kind-external-module tsd-is-external">
			<a href="_node_modules__quenk_preconditions_lib_result_failure_index_.html#explanation" class="tsd-kind-icon">Explanation</a>
		</li>
		<li class=" tsd-kind-type-alias tsd-parent-kind-external-module tsd-is-external">
			<a href="_node_modules__quenk_preconditions_lib_result_failure_index_.html#type" class="tsd-kind-icon">Type</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-class tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external"><a href="../classes/_node_modules__quenk_preconditions_lib_result_failure_index_.dualfailure.html" class="tsd-kind-icon">Dual<wbr>Failure</a></li>
							<li class="tsd-kind-class tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external"><a href="../classes/_node_modules__quenk_preconditions_lib_result_failure_index_.modifiedfailure.html" class="tsd-kind-icon">Modified<wbr>Failure</a></li>
							<li class="tsd-kind-class tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external"><a href="../classes/_node_modules__quenk_preconditions_lib_result_failure_index_.primfailure.html" class="tsd-kind-icon">Prim<wbr>Failure</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Interfaces</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-interface tsd-parent-kind-external-module tsd-is-external"><a href="../interfaces/_node_modules__quenk_preconditions_lib_result_failure_index_.context.html" class="tsd-kind-icon">Context</a></li>
							<li class="tsd-kind-interface tsd-parent-kind-external-module tsd-is-external"><a href="../interfaces/_node_modules__quenk_preconditions_lib_result_failure_index_.contexts.html" class="tsd-kind-icon">Contexts</a></li>
							<li class="tsd-kind-interface tsd-parent-kind-external-module tsd-is-external"><a href="../interfaces/_node_modules__quenk_preconditions_lib_result_failure_index_.errortemplates.html" class="tsd-kind-icon">Error<wbr>Templates</a></li>
							<li class="tsd-kind-interface tsd-parent-kind-external-module tsd-is-external"><a href="../interfaces/_node_modules__quenk_preconditions_lib_result_failure_index_.explanations.html" class="tsd-kind-icon">Explanations</a></li>
							<li class="tsd-kind-interface tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external"><a href="../interfaces/_node_modules__quenk_preconditions_lib_result_failure_index_.failure.html" class="tsd-kind-icon">Failure</a></li>
							<li class="tsd-kind-interface tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external"><a href="../interfaces/_node_modules__quenk_preconditions_lib_result_failure_index_.failures.html" class="tsd-kind-icon">Failures</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Type aliases</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-type-alias tsd-parent-kind-external-module tsd-is-external"><a href="_node_modules__quenk_preconditions_lib_result_failure_index_.html#explanation" class="tsd-kind-icon">Explanation</a></li>
							<li class="tsd-kind-type-alias tsd-parent-kind-external-module tsd-is-external"><a href="_node_modules__quenk_preconditions_lib_result_failure_index_.html#type" class="tsd-kind-icon">Type</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias tsd-parent-kind-external-module tsd-is-external">
				...
				<h3>Explanation</h3>
				<div class="tsd-signature tsd-kind-icon">Explanation<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><a href="../interfaces/_node_modules__quenk_preconditions_lib_result_failure_index_.explanations.html" class="tsd-signature-type">Explanations</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in node_modules/@quenk/preconditions/lib/result/failure/index.ts:15</li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Explanation of what went wrong with a Precondition.</p>
					</div>
					<p>This can be a string for a single precondition or a Record
					when multiple conditions have failed.</p>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-type-alias tsd-parent-kind-external-module tsd-is-external">
				...
				<aside class="tsd-sources">
					<ul>
						<li>Defined in node_modules/@quenk/preconditions/lib/result/failure/index.ts:7</li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
