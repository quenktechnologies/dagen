...
<head>
	...
	<title>&quot;node_modules/@quenk/preconditions/lib/result/index&quot; | @quenk/dagen</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class=" tsd-kind-type-alias tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
			<a href="_node_modules__quenk_preconditions_lib_result_index_.html#result" class="tsd-kind-icon">Result</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
			<a href="_node_modules__quenk_preconditions_lib_result_index_.html#fail" class="tsd-kind-icon">fail</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
			<a href="_node_modules__quenk_preconditions_lib_result_index_.html#succeed" class="tsd-kind-icon">succeed</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-type-alias tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external"><a href="_node_modules__quenk_preconditions_lib_result_index_.html#result" class="tsd-kind-icon">Result</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Functions</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external"><a href="_node_modules__quenk_preconditions_lib_result_index_.html#fail" class="tsd-kind-icon">fail</a></li>
							<li class="tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external"><a href="_node_modules__quenk_preconditions_lib_result_index_.html#succeed" class="tsd-kind-icon">succeed</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
				...
				<h3>Result</h3>
				<div class="tsd-signature tsd-kind-icon">Result<span class="tsd-signature-symbol">:</span> <a href="../classes/_node_modules__quenk_noni_lib_data_either_.either.html" class="tsd-signature-type">Either</a><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/_node_modules__quenk_preconditions_lib_result_failure_index_.failure.html" class="tsd-signature-type">Failure</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">A</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type">B</span><span class="tsd-signature-symbol">&gt;</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in node_modules/@quenk/preconditions/lib/result/index.ts:9</li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Result of a precondition type.</p>
					</div>
					<p>A precondition either fails or provides a new value.</p>
				</div>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
				...
				<h3><span class="tsd-flag ts-flagConst">Const</span> fail</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">fail&lt;A, B&gt;<span class="tsd-signature-symbol">(</span>msg<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, value<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">A</span>, ctx<span class="tsd-signature-symbol">?: </span><a href="../interfaces/_node_modules__quenk_preconditions_lib_result_failure_index_.context.html" class="tsd-signature-type">Context</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="_node_modules__quenk_preconditions_lib_result_index_.html#result" class="tsd-signature-type">Result</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">A</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type">B</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in node_modules/@quenk/preconditions/lib/result/index.ts:15</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>fail constructs a new failed Result using the parameters supplied to
								create a new Failure instance.</p>
							</div>
						</div>
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
				...
				<h3><span class="tsd-flag ts-flagConst">Const</span> succeed</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">succeed&lt;A, B&gt;<span class="tsd-signature-symbol">(</span>b<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">B</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="_node_modules__quenk_preconditions_lib_result_index_.html#result" class="tsd-signature-type">Result</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">A</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type">B</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in node_modules/@quenk/preconditions/lib/result/index.ts:23</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>succeed constructs a successful Result wraping the final version
								of the value in the right side of an Either.</p>
							</div>
						</div>
						<h4 class="tsd-type-parameters-title">Type parameters</h4>
						<ul class="tsd-type-parameters">
