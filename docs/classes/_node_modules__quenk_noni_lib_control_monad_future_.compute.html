...
<head>
	...
	<title>Compute | @quenk/dagen</title>
		...
		<li class="current tsd-kind-class tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
			...
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#canceller" class="tsd-kind-icon">canceller</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#exiterror" class="tsd-kind-icon">exit<wbr>Error</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#exitsuccess" class="tsd-kind-icon">exit<wbr>Success</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#running" class="tsd-kind-icon">running</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#stack" class="tsd-kind-icon">stack</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#value" class="tsd-kind-icon">value</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#abort" class="tsd-kind-icon">abort</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#onerror" class="tsd-kind-icon">on<wbr>Error</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#onsuccess" class="tsd-kind-icon">on<wbr>Success</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#run" class="tsd-kind-icon">run</a>
				</li>
			</ul>
		</li>
		<li class=" tsd-kind-class tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-private tsd-is-external">
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Compute represents the workload of a forked Future.</p>
				</div>
				<p>Results are computed sequentially and ends with either a value,
				error or prematurely via the abort method.</p>
			</div>
		</section>
		...
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">Compute</span>
				</li>
			</ul>
		</section>
		<section class="tsd-panel">
			<h3>Implements</h3>
			<ul class="tsd-hierarchy">
				<li><a href="../interfaces/_node_modules__quenk_noni_lib_control_monad_future_.supervisor.html" class="tsd-signature-type">Supervisor</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">A</span><span class="tsd-signature-symbol">&gt;</span></li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-external"><a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Properties</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#canceller" class="tsd-kind-icon">canceller</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#exiterror" class="tsd-kind-icon">exit<wbr>Error</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#exitsuccess" class="tsd-kind-icon">exit<wbr>Success</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#running" class="tsd-kind-icon">running</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#stack" class="tsd-kind-icon">stack</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#value" class="tsd-kind-icon">value</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#abort" class="tsd-kind-icon">abort</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#onerror" class="tsd-kind-icon">on<wbr>Error</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#onsuccess" class="tsd-kind-icon">on<wbr>Success</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html#run" class="tsd-kind-icon">run</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">new <wbr>Compute<span class="tsd-signature-symbol">(</span>value<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">A</span>, exitError<span class="tsd-signature-symbol">: </span><a href="../modules/_node_modules__quenk_noni_lib_control_monad_future_.html#onerror" class="tsd-signature-type">OnError</a>, exitSuccess<span class="tsd-signature-symbol">: </span><a href="../modules/_node_modules__quenk_noni_lib_control_monad_future_.html#onsuccess" class="tsd-signature-type">OnSuccess</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">A</span><span class="tsd-signature-symbol">&gt;</span>, stack<span class="tsd-signature-symbol">: </span><a href="_node_modules__quenk_noni_lib_control_monad_future_.future.html" class="tsd-signature-type">Future</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">A</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html" class="tsd-signature-type">Compute</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in node_modules/@quenk/noni/lib/control/monad/future.ts:359</li>
							</ul>
						</aside>
						...
						<ul class="tsd-parameters">
							...
							<li>
								<h5>exitError: <a href="../modules/_node_modules__quenk_noni_lib_control_monad_future_.html#onerror" class="tsd-signature-type">OnError</a></h5>
							</li>
							<li>
								<h5>exitSuccess: <a href="../modules/_node_modules__quenk_noni_lib_control_monad_future_.html#onsuccess" class="tsd-signature-type">OnSuccess</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">A</span><span class="tsd-signature-symbol">&gt;</span></h5>
							</li>
							<li>
								<h5>stack: <a href="_node_modules__quenk_noni_lib_control_monad_future_.future.html" class="tsd-signature-type">Future</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">A</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">[]</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html" class="tsd-signature-type">Compute</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				<a name="canceller" class="tsd-anchor"></a>
				<h3>canceller</h3>
				<div class="tsd-signature tsd-kind-icon">canceller<span class="tsd-signature-symbol">:</span> <a href="../modules/_node_modules__quenk_noni_lib_control_monad_future_.html#aborter" class="tsd-signature-type">Aborter</a><span class="tsd-signature-symbol"> =&nbsp;noop</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in node_modules/@quenk/noni/lib/control/monad/future.ts:357</li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				<a name="exiterror" class="tsd-anchor"></a>
				<h3>exit<wbr>Error</h3>
				<div class="tsd-signature tsd-kind-icon">exit<wbr>Error<span class="tsd-signature-symbol">:</span> <a href="../modules/_node_modules__quenk_noni_lib_control_monad_future_.html#onerror" class="tsd-signature-type">OnError</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in node_modules/@quenk/noni/lib/control/monad/future.ts:363</li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				<a name="exitsuccess" class="tsd-anchor"></a>
				<h3>exit<wbr>Success</h3>
				<div class="tsd-signature tsd-kind-icon">exit<wbr>Success<span class="tsd-signature-symbol">:</span> <a href="../modules/_node_modules__quenk_noni_lib_control_monad_future_.html#onsuccess" class="tsd-signature-type">OnSuccess</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">A</span><span class="tsd-signature-symbol">&gt;</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in node_modules/@quenk/noni/lib/control/monad/future.ts:364</li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<h3>running</h3>
				<div class="tsd-signature tsd-kind-icon">running<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol"> =&nbsp;false</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in node_modules/@quenk/noni/lib/control/monad/future.ts:359</li>
					</ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<h3>stack</h3>
				<div class="tsd-signature tsd-kind-icon">stack<span class="tsd-signature-symbol">:</span> <a href="_node_modules__quenk_noni_lib_control_monad_future_.future.html" class="tsd-signature-type">Future</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">A</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">[]</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in node_modules/@quenk/noni/lib/control/monad/future.ts:365</li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<aside class="tsd-sources">
					<ul>
						<li>Defined in node_modules/@quenk/noni/lib/control/monad/future.ts:362</li>
					</ul>
				</aside>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in node_modules/@quenk/noni/lib/control/monad/future.ts:404</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>abort this Compute.</p>
							</div>
							<p>Aborting a Compute will immediately clear its stack
							and invoke the canceller for the currently executing Future.</p>
						</div>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<h3>on<wbr>Error</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">on<wbr>Error<span class="tsd-signature-symbol">(</span>e<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Error</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<p>Implementation of <a href="../interfaces/_node_modules__quenk_noni_lib_control_monad_future_.supervisor.html">Supervisor</a>.<a href="../interfaces/_node_modules__quenk_noni_lib_control_monad_future_.supervisor.html#onerror">onError</a></p>
							<ul>
								<li>Defined in node_modules/@quenk/noni/lib/control/monad/future.ts:373</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
							...
							<p>This method will a &#39;Raise&#39; instruction at the top of the stack
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">on<wbr>Success<span class="tsd-signature-symbol">(</span>value<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">A</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<p>Implementation of <a href="../interfaces/_node_modules__quenk_noni_lib_control_monad_future_.supervisor.html">Supervisor</a>.<a href="../interfaces/_node_modules__quenk_noni_lib_control_monad_future_.supervisor.html#onsuccess">onSuccess</a></p>
							<ul>
								<li>Defined in node_modules/@quenk/noni/lib/control/monad/future.ts:388</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>onSuccess handler.</p>
							</div>
							<p>Stores the resulting value and continues the execution.</p>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<h3>run</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">run<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="_node_modules__quenk_noni_lib_control_monad_future_.compute.html" class="tsd-signature-type">Compute</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">A</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in node_modules/@quenk/noni/lib/control/monad/future.ts:415</li>
							</ul>
						</aside>
